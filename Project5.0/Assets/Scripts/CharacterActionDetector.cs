...
{
    public bool move_left, move_right, move_forward, move_backward, jump, jump_higher, squat, lean_left, lean_right, speed_toggle, item_rotate, general_action , general_action_hold;
